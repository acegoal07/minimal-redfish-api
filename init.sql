...
ALTER TABLE Assets ADD CONSTRAINT fk_assets_storage FOREIGN KEY (storageId) REFERENCES Storages (id) ON DELETE SET NULL;
...
CREATE TABLE
   _AssetsToTags (
      ...
      CONSTRAINT fk_assets_tags_asset FOREIGN KEY (assetId) REFERENCES Assets (id) ON DELETE CASCADE,
      CONSTRAINT fk_assets_tags_tag FOREIGN KEY (tagId) REFERENCES Tags (id) ON DELETE CASCADE
   );
