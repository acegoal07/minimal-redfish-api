...
const paramValidator = <T extends z.ZodRawShape>(validator: z.ZodObject<T>) =>
...
const bodyValidator = <T extends z.ZodRawShape>(validator: z.ZodObject<T>) =>
...
const queryValidator = <T extends z.ZodRawShape>(validator: z.ZodObject<T>) =>
...
const idParamValidator = <T extends z.ZodRawShape>(
   extra: T = {} as T
) => {
